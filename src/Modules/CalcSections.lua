...
{ 1, "SkillTypeStats", 1, colorCodes.OFFENCE, {{ defaultCollapsed = false, label = "Skill type-specific Stats", data = {
	...
	{ label = "Mana Cost", color = colorCodes.MANA, haveOutput = "ManaHasCost", { format = "{0:output:ManaCost}", { breakdown = "ManaCost" }, { label = "Cost multiplier modifiers", modName = "SupportManaMultiplier", modType = "MORE", modValueFormat = "typed", cfg = "skill" }, { label = "Cost modifiers", modName = { "ManaCost", "Cost", "ManaCostNoMult" }, cfg = "skill" }, }, },
	{ label = "Mana % Cost", color = colorCodes.MANA, haveOutput = "ManaPercentHasCost", { format = "{0:output:ManaPercentCost}", { breakdown = "ManaPercentCost" }, { label = "Cost multiplier modifiers", modName = "SupportManaMultiplier", modType = "MORE", modValueFormat = "typed", cfg = "skill" }, { label = "Cost modifiers", modName = { "ManaCost", "Cost", "ManaCostNoMult" }, cfg = "skill" }, }, },
	{ label = "Mana per second", color = colorCodes.MANA, haveOutput = "ManaPerSecondHasCost", { format = "{2:output:ManaPerSecondCost}", { breakdown = "ManaPerSecondCost" }, { label = "Cost multiplier modifiers", modName = "SupportManaMultiplier", modType = "MORE", modValueFormat = "typed", cfg = "skill" }, { label = "Cost modifiers", modName = { "ManaCost", "Cost", "ManaCostNoMult" }, cfg = "skill" }, }, },
	{ label = "Mana % per second", color = colorCodes.MANA, haveOutput = "ManaPercentPerSecondHasCost", { format = "{2:output:ManaPercentPerSecondCost}", { breakdown = "ManaPercentPerSecondCost" }, { label = "Cost multiplier modifiers", modName = "SupportManaMultiplier", modType = "MORE", modValueFormat = "typed", cfg = "skill" }, { label = "Cost modifiers", modName = { "ManaCost", "Cost", "ManaCostNoMult" }, cfg = "skill" }, }, },
	{ label = "Life Cost", color = colorCodes.LIFE, haveOutput = "LifeHasCost", { format = "{0:output:LifeCost}", { breakdown = "LifeCost" }, { label = "Cost multiplier modifiers", modName = "SupportManaMultiplier", modType = "MORE", modValueFormat = "typed", cfg = "skill" }, { label = "Cost modifiers", modName = { "LifeCost", "Cost", "LifeCostNoMult" }, cfg = "skill" }, }, },
	{ label = "Life % Cost", color = colorCodes.LIFE, haveOutput = "LifePercentHasCost", { format = "{0:output:LifePercentCost}", { breakdown = "LifePercentCost" }, { label = "Cost multiplier modifiers", modName = "SupportManaMultiplier", modType = "MORE", modValueFormat = "typed", cfg = "skill" }, { label = "Cost modifiers", modName = { "LifeCost", "Cost", "LifeCostNoMult" }, cfg = "skill" }, }, },
	{ label = "Life per second", color = colorCodes.LIFE, haveOutput = "LifePerSecondHasCost", { format = "{2:output:LifePerSecondCost}", { breakdown = "LifePerSecondCost" }, { label = "Cost multiplier modifiers", modName = "SupportManaMultiplier", modType = "MORE", modValueFormat = "typed", cfg = "skill" }, { label = "Cost modifiers", modName = { "LifeCost", "Cost", "LifeCostNoMult" }, cfg = "skill" }, }, },
	{ label = "Life % per second", color = colorCodes.LIFE, haveOutput = "LifePercentPerSecondHasCost", { format = "{2:output:LifePercentPerSecondCost}", { breakdown = "LifePercentPerSecondCost" }, { label = "Cost multiplier modifiers", modName = "SupportManaMultiplier", modType = "MORE", modValueFormat = "typed", cfg = "skill" }, { label = "Cost modifiers", modName = { "LifeCost", "Cost", "LifeCostNoMult" }, cfg = "skill" }, }, },
